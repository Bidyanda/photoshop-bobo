      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-5 col-xl-4">
            <div class="wow-outer">
              <h6 class="font-weight-sbold text-primary wow slideInDown">I'm Bobocha Mutum</h6>
            </div>
          </div>
        ...
        <div class="slick-slider carousel-parent" data-arrows="false" data-loop="true" data-dots="false" data-swipe="false" data-items="1" data-fade="true" data-child="#child-carousel" data-for="#child-carousel">
          <div class="item">
            <blockquote class="quote-light">
              ...
              <div class="quote-light-text">
                <p>I absolutely loved my session and all of the pictures that came from it. You have a clear passion for what you do and it shows through your work! I highly recommend Bobocha M for any photography needs! </p>
              </div>
            </blockquote>
          </div>
          <div class="item">
            <blockquote class="quote-light">
              ...
              <p class="quote-light-caption">Regular Client</p><span class="icon quote-light-mark linearicons-quote-open"></span>
              <div class="quote-light-text">
                <p>I was so happy with the pictures Babu took. He was very kind and patient with my two-month old and my energetic 6 y.o. children. I will be going to Babu from now on!</p>
              </div>
            </blockquote>
          </div>
          <div class="item">
          ...
          <div class="item">
            <blockquote class="quote-light">
              ...
              <p class="quote-light-caption">Regular Client</p><span class="icon quote-light-mark linearicons-quote-open"></span>
              <div class="quote-light-text">
                <p>Bobocha is truly an outstanding photographer (and wonderful person) with an almost mystical ability to capture the true nature of people and events. I recommend him to anyone!</p>
              </div>
            </blockquote>
          </div>
          <div class="item">
          ...
          <div class="item">
            <blockquote class="quote-light">
              ...
              <p class="quote-light-caption">Regular Client</p><span class="icon quote-light-mark linearicons-quote-open"></span>
              <div class="quote-light-text">
                <p>I have contracted Bobocha for 3 family events and have always been 100% satisfied. He has been available and responsive anytime I have had questions and has always had the patience to help me.</p>
              </div>
            </blockquote>
          </div>
        </div>
